...
open class TextFieldEffects : UITextField {
    ...
    /**
     The type of text alignment a placeholder can perform.

     - fixed: animation which uses fixed placement in a text field (0.6 * width of textField).
     - flexibleRightAligned: animation which uses flexible width of the placeholder text aligning it on the right side.
     */
    public enum AlignType: Int {
        case fixed
        case flexibleRightAligned
    }
    ...
    open var alignType = AlignType.fixed
